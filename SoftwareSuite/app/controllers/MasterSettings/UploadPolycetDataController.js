define(['app'], function (app) {
    app.controller("UploadPolycetDataController", function ($scope, $http, $localStorage, $rootScope, $state, $stateParams, $document, AppSettings, $timeout, PreExaminationService, AssessmentService, StudentWiseService) {
        ...
        $scope.UploadExcel = function () {
            ...
            $scope.reload = true;
            var type = 1;
            var uploadJson = PreExaminationService.UploadPolycetData($scope.AcademicYear, $scope.AdmissionType, $scope.JsonObj);
