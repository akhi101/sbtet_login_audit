define(['app'], function (app) {
    app.controller("EditCandidateDetailsController", function ($scope, CcicSystemUserService, $localStorage, $state, CcicPreExaminationService) {
        ...
        $scope.toggleAadharVisibility = function () {
            ...
            $scope.eyeIcon = ($scope.inputType === 'password') ? '???' : '??';
        };
