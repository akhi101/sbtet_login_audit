define(['app'], function (app) {
    app.controller("AbsentEntryScheduleListController", function ($scope, $state, AppSettings, BasicMarksEntrScheduleService) {
        ...
        var gridColumns = [
            ...
            { field: "StartTime", headerText: "Start Time", textAlign: ej.TextAlign.Left, width: 40 },
            { field: "EndTime", headerText: "End Time", textAlign: ej.TextAlign.Left, width: 20 },
        ...
        function AddNew() {
            ...
            //    return;
            // } else {
            $state.go('Masters.AbsentEntrySchedule', { MarkEntrSchID: 0 });
            //}
        }
        // Edit delete record
        $scope.doubleclick = function doubleclick(sender, args) {
            if (this.multiSelectCtrlRequest == false) {
                $state.go('Masters.AbsentEntrySchedule', { MarkEntrSchID: sender.data.MarkEntrSchID });
            }
        }

        var ExmSchType = "3";

        var BasicMarksEntrScheduledata = BasicMarksEntrScheduleService.GetMarkEntryScheduleListByExmSchType(ExmSchType);
