define(['app'], function (app) {
    app.controller("PreExmSpelPractController", function ($scope, $state, $stateParams, AppSettings, PreExmSpelPractService, BasicDistrictsService, PreZoneService, PrePractCenterService) {
        ...
        if ($scope.PreExmSpelPract.PreExmSplPrID > 0) {
            ...
            //var CenterList = PreExmSpelPractService.GetPracCenterList(AppSettings.ExamInstID);
        ...
        $scope.SavePreExmSpelPract = function () {
            ...
            $scope.PreExmSpelPract.ZoneType = 2;
        ...
        $scope.DeletePreExmSpelPract = function () {
            var getData = PreExmSpelPractService.GetDeletePreExmSpelPract($scope.PreExmSpelPract.PreExmSplPrID, AppSettings.LoggedUserId);
        ...
        //    var PreZoneList = PreZoneService.GetPreZoneBYDistrictIDForSpell(DistrictID,2);
        ...
        //        var CenterList = PreExmSpelPractService.GetPracCenterListByDistrictIDandZoneID(AppSettings.ExamInstID, DistrictID, ZoneID, 2);
        //        CenterList.then(function (data) {
        //            $scope.Centerdata = data;
        //        }, function (error) {
        //            alert(error);
        ...
        //var CenterList = PrePractCenterService.GetPracticalCenterListForSpell(AppSettings.ExamInstID,2);
        //CenterList.then(function (data) {
        //    $scope.Centerdata = data;
        //}, function (error) {
        //    alert(error);
        ...
        function RedirectToListPage() {
            $state.go('PreExam.PreExmSpelPractList');
        }
    });
});
