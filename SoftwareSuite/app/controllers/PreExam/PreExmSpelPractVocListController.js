define(['app'], function (app) {
    app.controller("PreExmSpelPractVocListController", function ($scope, $state, AppSettings, PreExmSpelPractService) {
        ...
        function AddNew() {
            ...
            //    return;
            // } else {
            $state.go('PreExam.PracticalSpellVoc', { PreExmSplPrID: 0 });
            //}
        }
        // Edit delete record
        $scope.doubleclick = function doubleclick(sender, args) {
            if (this.multiSelectCtrlRequest == false) {
                $state.go('PreExam.PracticalSpellVoc', { PreExmSplPrID: sender.data.PreExmSplPrID });
            }
        }
        var PreExmSpelPractdata = PreExmSpelPractService.GetPreExmSpelPractListForVocational(AppSettings.ExamInstID);
