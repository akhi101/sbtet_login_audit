define(['app'], function (app) {
    app.controller("DistrictWiseTHANSBKREQSTNTController", function ($scope, $filter, $state, $interval, $stateParams, AppSettings, preExaminerAppointmentsService, BasicDistrictsService) {
       
     

        

        $scope.GetDistrictWiseTHAnsBookReqStatement = function () {
            if (CheckValidation() == true) {
                ...
                Urlstring = "api/PreExaminerAppointments/GetDistrictWiseTheoryAnswerBookRequirementStatement/?ExamInstID=" + AppSettings.ExamInstID + "&DistrictID=" + $scope.DistrictWiseCount.DistrictID + "";
                $.ajax({
        ...
        $("#container").ejReportViewer(
            {
                ...
                reportPath: "RptDistrictWiseThAnsBookReqSt.rdlc",
                dataSources: [{ value: [], name: "dsDistrictWiseThAnsBookReqSt" }],
