(function () {
    'use strict';
    angular.module('app')
        .controller('practicalDetailEntryCollegeController',
            function ($rootScope, $scope, $state, basicCourseService, basicExamService, examTimeTableService, practicalEntryService, basicZoneService, basicBranchService, basicDistrictsService, AppSettings) {
                ...
                $scope.$watch('practicalEntryDetailCollege.CourseID', function () {
                    if ($scope.practicalEntryDetailCollege.CourseID !== undefined) {
                        ...
                        basicExamService.getBasicExamListByCourseID($scope.practicalEntryDetailCollege.CourseID).then(function (results) {
                            ...
                            if ($scope.practicalEntryDetailCollege.CourseID !== undefined) {
                                if ($scope.practicalEntryDetailCollege.CourseID == 1) {
                                    $scope.practicalEntryDetailCollege.ExamID = 2;
                        ...
                        practicalEntryService.getCheckCenterCollegePresent(AppSettings.CollegeID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.CourseID).then(function (results) {
                            if (results == 0) {
                ...
                $scope.$watch('practicalEntryDetailCollege.ExamID', function () {
                    if ($scope.practicalEntryDetailCollege.ExamID !== undefined) {
                        //practicalEntryService.getFillBatchData(AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.ExamID, $scope.practicalEntryDetailCollege.PrePractCntrID).then(function (results) {
                    ...
                    if ($scope.practicalEntryDetailCollege.CourseID == 1) {
                        ...
                        $scope.practicalEntryDetailCollege.ZoneType = 3;
                    }
                    if ($scope.practicalEntryDetailCollege.BranchID !== undefined && $scope.practicalEntryDetailCollege.ExamID !== undefined) {
                        ...
                        practicalEntryService.getExamTimeTableSubjectListByExamIDBranchID($scope.practicalEntryDetailCollege.ExamID, $scope.practicalEntryDetailCollege.BranchID, $scope.practicalEntryDetailCollege.ExamInstID).then(function (results) {
                    ...
                    if ($scope.practicalEntryDetailCollege.ExamID !== undefined) {
                        practicalEntryService.getCheckCenterCollegePresent(AppSettings.CollegeID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.CourseID).then(function (results) {
                            if (results == 0) {
                                ...
                                $scope.practicalEntryDetailCollege.PrePractCntrID = "" + results[0].PrePractCntrID + "";
                                $scope.practicalEntryDetailCollege.ZoneID = results[0].ZoneID;
                                practicalEntryService.getExamTimeSchedulePresent($scope.practicalEntryDetailCollege.ExamID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.PrePractCntrID, $scope.practicalEntryDetailCollege.ZoneType).then(function (results) {
                                    if (results.length == 0) {
                ...
                $scope.$watch('practicalEntryDetailCollege.ExmSubID', function () {
                    if ($scope.practicalEntryDetailCollege.ExmSubID !== undefined && $scope.practicalEntryDetailCollege.ExamID !== undefined) {
                        if ($scope.practicalEntryDetailCollege.CourseID == 1) {
                            $scope.practicalEntryDetailCollege.ZoneType = 2;
                        } else {
                            $scope.practicalEntryDetailCollege.ZoneType = 3;
                        ...
                        practicalEntryService.getFillBatchData(AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.ExamID, $scope.practicalEntryDetailCollege.PrePractCntrID, $scope.practicalEntryDetailCollege.ExmSubID, $scope.practicalEntryDetailCollege.BatchFlag, $scope.practicalEntryDetailCollege.ZoneType,0).then(function (results) {
                            $scope.examBatches = results;
                            ...
                            practicalEntryService.getExamTimeSchedulePresent($scope.practicalEntryDetailCollege.ExamID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.PrePractCntrID, $scope.practicalEntryDetailCollege.ZoneType).then(function (resultsnew) {
                                if (resultsnew.length == 0) {
                                    alert("Mark Entry Schedule not available");
                                    $state.go('PreExam');
                                } else {
                                    if ($scope.practicalEntryDetailCollege.BatchFlag == 'M') {
                                        $scope.StartTime = resultsnew[0].MornigStartTime;
                                        $scope.EndTime = resultsnew[0].MornigEndTime;
                                        $scope.MornigStartTime = resultsnew[0].MornigStartTime;
                                        $scope.MornigEndTime = resultsnew[0].MornigEndTime;
                                        $scope.Session = "FN Session";
                                    }
                                    else {
                                        $scope.StartTime = resultsnew[0].AfterNoonStartTime;
                                        $scope.EndTime = resultsnew[0].AfterNoonEndTime;
                                        $scope.AfterNoonStartTime = resultsnew[0].AfterNoonStartTime;
                                        $scope.AfterNoonEndTime = resultsnew[0].AfterNoonEndTime;
                                        $scope.Session = "AN Session";
                                    }
                                }
                            });
                        });
                        practicalEntryService.getExaminerDatabyCenter(AppSettings.CollegeID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.ExamID, $scope.practicalEntryDetailCollege.ExmSubID, $scope.practicalEntryDetailCollege.ZoneType).then(function (results) {
                            if (results.length > 0) {
                            ...
                            $scope.practicalEntryDetailCollege.Prdate = new Date();
                        });
                    }
                });
                    ...
                    if ($scope.practicalEntryDetailCollege.PrBatchID != undefined && $scope.practicalEntryDetailCollege.PrBatchID != "") {
                        ...
                        for (var i = 0; i < $scope.examBatches.length; i++) {
                            if ($scope.practicalEntryDetailCollege.PrBatchID == $scope.examBatches[i].PrBatchID) {
                                ...
                                if ($scope.examBatches[i].BatchFlag == "M") {
                                    practicalEntryService.getExamTimeSchedulePresentMorning($scope.practicalEntryDetailCollege.ExamID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.PrePractCntrID, $scope.practicalEntryDetailCollege.ZoneType).then(function (results) {
                                        if (results.length == 0) {
                                            alert("Mark Entry Schedule not available");
                                    ...
                                    practicalEntryService.getExamTimeSchedulePresentEvening($scope.practicalEntryDetailCollege.ExamID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.PrePractCntrID, $scope.practicalEntryDetailCollege.ZoneType).then(function (results) {
                                        if (results.length == 0) {
                                            alert("Mark Entry Schedule not available");
                                            $scope.OTPDisable = true;
                                            $scope.SubmitDisable = true;
                                ...
                                //        }
                                //        if ($scope.practicalEntryDetailCollege.BatchFlag == "M") {
                                //            if ($scope.Session == "AN Session") {
                                //                $scope.OTPDisable = true;
                                //                $scope.SubmitDisable = true;
                                //            }
                                //        }
                                //        if ($scope.practicalEntryDetailCollege.BatchFlag == "N") {
                                //            if ($scope.Session == "FN Session") {
                                //                $scope.OTPDisable = true;
                                //                $scope.SubmitDisable = true;
                                //            }
                                //        }
                        ...
                        //if ($scope.examBatches.length > 1) {
                        //    if ($scope.practicalEntryDetailCollege.PrBatchID == $scope.examBatches[$scope.examBatches.length - 1].PrBatchID) {
                        //        if (($scope.OldBatchFlag == 'FN') && ($scope.Session !="AN Session")) {
                        //            $scope.OTPDisable = true;
                        //            $scope.SubmitDisable = true;
                        //        } else {
                        //            $scope.OTPDisable = false;
                ...
                $scope.SendOTP = function () {
                    ...
                    $scope.practicalEntryDetailCollege.Session = $scope.Session;
                ...
                $scope.showStudentDetailsNew = function () {
                    ...
                    if (($scope.practicalEntryDetailCollege.OTP == "") || ($scope.practicalEntryDetailCollege.OTP == undefined)) {
                                    ...
                                    if ($scope.studentDetailList[i].StatusFlag == "P") {
                                        if ($scope.studentDetailList[i].ChkListFlag != 'V') {
                                            ...
                                            if ($scope.studentDetailList[i].Marks.toString().length == 1) {
                                                if ($scope.studentDetailList[i].Marks != "0") {
                        ...
                        practicalEntryService.getStudentDetailsByExamSubject($scope.practicalEntryDetailCollege).then(function (results) {
                            if (results.length > 0) {
                                ...
                                for (var i = 0; i < results.length; i++) {
                                    ...
                                    results[i].DisableChecklistflag = true;
                                    $scope.MFNumber = results[i].MFNumber;
                ...
                $scope.postpracticalEntryDetailCollege = function () {
                    ...
                    if ($scope.practicalStudentDetailForm.$valid && $scope.practicalEntryDetailCollegeForm.$valid && $scope.studentDetailList.length > 0) {
                        ...
                        for (var i = 0; i < $scope.studentDetailList.length; i++) {
                            ...
                            $scope.studentDetailList[i].PractType = 1;
                        ...
                        if ($scope.isCorrect) {
                            if ($scope.updatedStudentInfoList.length > 0) {
                                ...
                                $scope.practicalEntryDetailCollege.CreateLoginID = AppSettings.LoggedUserId;
                                $scope.practicalEntryDetailCollege.PractType = 1;
                                $scope.practicalEntryDetailCollege.CenterCollegeID = AppSettings.CollegeID;
                                $scope.postPracticalEntry.practicalEntryDetailColleges = $scope.practicalEntryDetailCollege;

                                practicalEntryService.getExamTimeSchedulePresent($scope.practicalEntryDetailCollege.ExamID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.PrePractCntrID, $scope.practicalEntryDetailCollege.ZoneType).then(function (resultsPre) {
                                    if (resultsPre.length == 0) {
                                        alert("Mark Entry session expired.");
                                        $scope.txtOTPDisable = false;
                                        $scope.SubmitDisable = false;
                                    } else {
                                        ...
                                        //practicalEntryService.GetHTNoPresentInPreStudentMarks(HTNOs,$scope.practicalEntryDetailCollege.ExamID, AppSettings.ExamInstID, AppSettings.CollegeID, $scope.practicalEntryDetailCollege.ExmSubID).then(function (results) {
                                        //    if (results.length > 0) {
                                        //        if (results[0].StatusFlag == "A") {
                                        //            var isConfirmed = confirm("HTNo : " + results[0].HTNO + " is already Absent in preivous batch, You wan't allowed ?");
                                        //            if (isConfirmed) {
                                        //                $scope.savedata();
                                        //            } else {
                                        //                results[0].HTNO = "";
                                        ...
                                        //            alert("HTNo : " + results[0].HTNO + " is already Present in preivous batch , You Can not add this.");
                                        //            results[0].HTNO = "";
                                        //            return;
                                        //        }
                                        //    } else {
                ...
                $scope.savedata = function () {
                    ...
                    practicalEntryService.postPracticalEntry($scope.postPracticalEntry).then(function (results) {
                        if (results.IsSuccess) {
                            ...
                            //var isConfirmed = confirm("After Submit you cannnot edit, Do you want to ve change any status/marks.");
                            if (isConfirmed) {
                ...
                $scope.postpracticalEntryDetailCollegeFinalSubmit = function () {
                    ...
                    practicalEntryService.postPracticalEntryFinalSubmit($scope.postPracticalEntry).then(function (results) {
                        if (results.IsSuccess) {
                            ...
                            //$state.go('PreExam');
                            $state.go('PreExam.PracticalMarkEntryAcknowledgementReport', { PrePractCntrID: $scope.practicalEntryDetailCollege.PrePractCntrID, ExmSubID: $scope.practicalEntryDetailCollege.ExmSubID, BatchNo: $scope.practicalEntryDetailCollege.BatchNo, ExamID: $scope.practicalEntryDetailCollege.ExamID, PrDate : "" } );
                            $scope.DisableFinalSubmit = true;
                            $scope.savedisable = true;
                            $scope.loading = false;
                ...
                //        reportPath: "RptVocPractAwardListAcknowledgeMent.rdlc",
                ...
                $scope.CheckHTNOValidation = function (HTNO) {
                    if (HTNO != "") {
                        ...
                        practicalEntryService.GetHTNoPresentInPreStudentMarks(HTNO, $scope.practicalEntryDetailCollege.ExamID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.PrePractCntrID, $scope.practicalEntryDetailCollege.ExmSubID).then(function (results) {
                            if (results.length > 0) {
                                if ((results[0].PrCentreID != $scope.practicalEntryDetailCollege.PrePractCntrID) || (results[0].BatchNo != $scope.practicalEntryDetailCollege.BatchNo)){
                                    $scope.studentDetailList[$scope.studentDetailList.length - 1].AnotherCenterFlag = "Y";
                                } else {
                                    $scope.studentDetailList[$scope.studentDetailList.length - 1].AnotherCenterFlag = "N";
                                }
                                ...
                                if (results[0].StatusFlag == "A") {
                                    ...
                                    $scope.studentDetailList[$scope.studentDetailList.length - 1].StudName = "";
                                    return;
                                    //    var isConfirmed = confirm("HTNo : " + results[0].HTNoBarCode + " is already Present in another batch , You wan't allowed");
                                    //    if (isConfirmed) {
                                    //    } else {
                                    //        $scope.studentDetailList[$scope.studentDetailList.length - 1].HTNO = "";
                                    //        $scope.studentDetailList[$scope.studentDetailList.length - 1].StudName = "";
                                ...
                                practicalEntryService.GetHTNoPresentInExamForms(HTNO, $scope.practicalEntryDetailCollege.ExamID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.PrePractCntrID, $scope.practicalEntryDetailCollege.ExmSubID, $scope.practicalEntryDetailCollege.BatchNo,2).then(function (resultspre) {
                                    if (resultspre.length > 0) {
                                        if ((resultspre[0].PrCentreID != $scope.practicalEntryDetailCollege.PrePractCntrID) || (resultspre[0].BatchNo != $scope.practicalEntryDetailCollege.BatchNo)){
                                            $scope.studentDetailList[$scope.studentDetailList.length - 1].AnotherCenterFlag = "Y";
                                        } else {
                                            $scope.studentDetailList[$scope.studentDetailList.length - 1].AnotherCenterFlag = "N";
                                        }
                                        ...
                                        //if (resultspre[0].DistrictID != resultspre[0].DistrictIDCenter) {
                                        //    alert("District is different, You Can not add this.");
                                        //    $scope.studentDetailList[$scope.studentDetailList.length - 1].HTNO = "";
                                        //    return;
                                        //}
                                        //if (resultspre[0].BatchNo > $scope.practicalEntryDetailCollege.BatchNo) {
                                        //    alert("HTNo is already Present in next batch , You Can not add this.");
                                        //    HTNO = "";
                                        //    $scope.studentDetailList[$scope.studentDetailList.length - 1].HTNO = "";
                                        //    return;
                                        //}
                ...
                $scope.GetCheckMarks = function (studentDetail) {
                    ...
                    if (studentDetail.Marks > studentDetail.MaxMarks) {
                        ...
                        if ((studentDetail.Marks == "A") || (studentDetail.Marks == "a")) {
                            ...
                            studentDetail.Inwords = "Not Offered";
                        }
                ...
                $scope.printDiv = function (divName) {
                    ...
                    $state.go('PreExam.practicalDetailEntryCollege');
                }
