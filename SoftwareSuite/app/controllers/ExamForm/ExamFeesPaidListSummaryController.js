define(['app'], function (app) {
    app.controller("ExamFeesPaidListSummaryController", function ($scope, $state, AppSettings, ExamFeesPaidService, ExamFormsCancelService) {
       // $scope.Success = { AcqResponseCode: $stateParams.AcqResponseCode, MerchTxnRef: $stateParams.MerchTxnRef };
        ...
        $scope.Show = function () {
            ...
            var ExamFormData = ExamFeesPaidService.GetExamFeesPaidListSummary(AppSettings.ExamInstID, $scope.ExamFeesPaidList.CollegeID, $scope.ExamFeesPaidList.CourseID, $scope.ExamFeesPaidList.ExamID);
        ...
        $scope.DeSelect = function () {
            ...
            var Updatedeletedata = ExamFeesPaidService.GetUpdateDeselectStudent(AppSettings.ExamInstID, $scope.PreStudRegIDs, $scope.ExamFeesPaidList.CollegeID, $scope.studpageAdmissionList[0].ChallanNo, $scope.studpageAdmissionList[0].CollegeTransDate, $scope.DelFees, $scope.DelCnt);
       ...
       // $scope.paybtndisable = false;
        ...
        $scope.GetStudentDetails = function (obj) {
            ...
            var TotalRecorddata = ExamFeesPaidService.GetStudentDetailsByTransactionID(AppSettings.ExamInstID, AppSettings.CollegeID, obj.ChallanID, obj.CollegeTransDate, $scope.ExamFeesPaidList.ExamID, $scope.ExamFeesPaidList.CourseID, obj.TransactionID);
            TotalRecorddata.then(function (data) {
                var to = 0;
                for (var k = 0; k < data.length; k++) {
