define(['app'], function (app) {
    app.controller("TcApprovalListController", function ($scope, $http, $localStorage, $state, AppSettings, PreExaminationService) {
        ...
        var ApproveList = PreExaminationService.GetTcApprovalList($scope.College_Code, $scope.UserTypeId,$scope.BranchId);
        ...
        $scope.ApprovePending = function (Scheme) {
            ...
            $state.go('Dashboard.PostExam.TcApprovalListDetails');
        }
