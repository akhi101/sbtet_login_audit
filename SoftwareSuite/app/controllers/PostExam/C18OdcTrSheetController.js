define(['app'], function (app) {
    app.controller("C18OdcTrSheetController", function ($scope, $q, $http, PreExaminationService, $localStorage, $state, $stateParams, AppSettings) {
        ...
        $scope.DownloadODCTrsheet = function () {
            ...
            console.log(JSON.stringify($scope.CollegeTypesArray))
            var CertificateFeePaymentReports = PreExaminationService.GetC18OdcTrSheets($scope.ExamMonth, JSON.stringify($scope.CollegeTypesArray));
