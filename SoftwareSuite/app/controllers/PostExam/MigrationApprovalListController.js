define(['app'], function (app) {
    app.controller("MigrationApprovalListController", function ($scope, $http, $localStorage, $state, $stateParams, AppSettings, $uibModal, $timeout, PreExaminationService) {
        ...
        var ApproveList = PreExaminationService.GetMigrationApprovalList($scope.UserTypeId);
        ...
        $scope.ApprovePending = function (Scheme, count) {
            if (count >= 1) {
                ...
                $state.go('Dashboard.PostExam.MigrationApprovalListdetails');
            }
        }
