define(['app'], function (app) {
    app.controller("VocPractCenterAllocStudListController", function ($scope, $state, $stateParams, AppSettings, BasicDistrictsService, BasicExamService, BasicCourseService, BasicCollegeService, PrePractCenterService, PreVocationalCenterService, BasicMainGroupService, BasicExamSubjectService, practicalEntryService) {
        ...
        BasicCourseList.then(function (CourseData, status, headers, config, error) {
            ...
            $scope.PracticalCenterAllocationStudentList.CourseID = "2";
        ...
        $scope.GetPracticalExamStudentListReportbyCenter = function () {
            ...
            if (CheckValidation() == true) {
                var Urlstring = "api/PrePractCenter/GetVocationalPracticalBatchStudentList/?ExamInstID=" + AppSettings.ExamInstID + "&PrePractCntrID=" + $scope.PracticalCenterAllocationStudentList.PrePractCntrID + "&ExamID=" + $scope.PracticalCenterAllocationStudentList.ExamID + "&DistrictID=" + $scope.PracticalCenterAllocationStudentList.DistrictID;
                $.ajax({
        ...
        $("#reportviewer").ejReportViewer(
            {
                ...
                reportPath: "RptCenterWiseGroupWiseBatchWiseVocStudList.rdlc",
