define(['app'], function (app) {
    app.controller("PracticalCenterAllocationController", function ($scope, $state, $stateParams, AppSettings, PreZoneCenterService, BasicDistrictsService, BasicExamService, BasicCourseService) {
        ...
        $scope.PracticalCenterAllocationProcess = function () {
            ...
            if (CheckValidation() == true) {
                ...
                var getPromise = PreZoneCenterService.PracticalCenterAllocationProcess($scope.PracticalCenterAllocation);
        ...
        function RedirectToListPage() {
            $scope.isupdatableDisable = false;
            $state.go('CenterManagemnet.PracticalCenterAllocation');
        }
    });
});
