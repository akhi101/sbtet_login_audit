define(['app'], function (app) {
    app.service("TCAdmissionAppService", function (DataAccessService) {
        this.GetReqTCAdmissionByID = function (TCAdmissionID) {
            var paramObject = { "TCAdmissionID": TCAdmissionID };
            var promise = DataAccessService.getDataWithPara('api/ReqTCAdmission/GetReqTCAdmissionByID', paramObject);
            return promise;
        }
        this.UpdateTCAdmissionApp = function (object) {
            var promise = DataAccessService.postData('api/ReqTCAdmission/PostApprovedReqTCAdmission', object);
            return promise;
        }
        this.GetCertPdf = function (FormNo) {
            var paramObject = { "FormNo": FormNo };
            var promise = DataAccessService.getDataWithPara('api/ReqTCAdmission/GetCertPdf', paramObject);
            return promise;
        }
