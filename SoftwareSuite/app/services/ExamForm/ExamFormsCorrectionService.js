define(['app'], function (app) {
    app.service("ExamFormsCorrectionService", function (DataAccessService) {
        this.AddExamFormsCorrection = function (object) {
            var promise = DataAccessService.postData('api/ExamForms/AddExamFormsCorrection', object); //PutExamForms
            return promise;
        }
        ...
        this.GetCandidatePhoto = function (PRNNo, CollegeID) {
            var paramObject = { "strPRNNo": PRNNo, "CollegeID": CollegeID };
            var promise = DataAccessService.getDataWithPara('api/ExamForms/GetCandidatePhoto', paramObject);
            return promise;
        }
