define(['app'], function (app) {
    app.service("ExamFormsBridgeCourseService", function (DataAccessService) {
        this.AddExamFormsBridgeCourse = function (object) {
            var promise = DataAccessService.postData('api/ExamForms/PostInsertExamFormsForBridgeCourse', object); //PutExamForms
            return promise;
        }
        this.UpdateExamFormsBridgeCourse = function (object) {
        ...
        this.DeleteExamFormsBridgeCourse = function (ExmFrmID, UpdLoginID) {
        ...
        this.GetExamFormsBridgeCourseList = function (ExamInstID, CollegeID, CourseID, ExamID, BranchID) {
            var paramObject = { "ExamInstID": ExamInstID, "CollegeID": CollegeID, "CourseID": CourseID, "ExamID": ExamID, "BranchID": BranchID };
            var promise = DataAccessService.getDataWithPara('api/ExamForms/GetExamFormsListBridgeCourse', paramObject);
            return promise;
        }
        this.GetExamFormsBridgeCourseById = function (ExmFrmID) {
        ...
        this.GetExamFormDataByPrnNoForBridgeCourse = function (PRNNo, ExamInstID, CollegeID, CourseID, ExamID, BranchID) {
            ...
            var promise = DataAccessService.getDataWithPara('api/ExamForms/GetExamFormDataByPrnNoForBridgeCourseNew', paramObject);
            return promise;
        }
