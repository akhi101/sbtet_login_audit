...
public static class MyScheduler
{
    ...
    public static void CallInPertucularDateScheduleTask(int Year, int Month, int Day, int hour, int min, double interval, Action task)
    {
        interval = 0;
        SchedulerService.Instance.CallInPertucularDateScheduleTask(Year, Month, Day, hour, min, interval, task);
    }
}