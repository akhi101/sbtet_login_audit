    ...
    angular
        ...
        .directive('saDate',function () {
            ...
            function link(scope, element, attrs, formCtrl) {
               ...
               // angular.isDefined(scope.objectdisable) ? scope.objectdisable : 
                ...
                scope.format = angular.isDefined(scope.dateformat) ? scope.dateformat :'dd-MMMM-yyyy';
