define(['app'], function (app) {
    app.service("ExamFormsImprovementService", function (DataAccessService) {
        this.AddExamFormsImprovement = function (object) {
            var promise = DataAccessService.postData('api/ExamForms/PostInsertExamForms', object); //PutExamForms
            return promise;
        }
        this.UpdateExamFormsImprovement = function (object) {
            var promise = DataAccessService.postData('api/ExamForms/PostExamForms', object);
            return promise;
        }
        this.DeleteExamFormsImprovement = function (ExmFrmID, UpdLoginID) {
        ...
        this.GetExamFormsImprovementList = function (ExamInstID, CollegeID, CourseID, ExamID, BranchID) {
            var paramObject = { "ExamInstID": ExamInstID, "CollegeID": CollegeID, "CourseID": CourseID, "ExamID": ExamID, "BranchID": BranchID };
            var promise = DataAccessService.getDataWithPara('api/ExamForms/GetExamFormsListImprovement', paramObject);
            return promise;
        }
        this.GetExamFormsImprovementById = function (ExmFrmID) {
        ...
        this.GetExamFormDataByPrnNo = function (PRNNo, ExamInstID, CollegeID, CourseID, ExamID, BranchID) {
            ...
            var promise = DataAccessService.getDataWithPara('api/ExamForms/GetExamFormDataByPrnNoForImprovement', paramObject);
            return promise;
        }
        ...
        this.GetCheckPRNNoPresent = function (PRNNo, ExamInstID, ForCourse) {
            var paramObject = { "PRNNo": PRNNo, "ExamInstID": ExamInstID, "ForCourse": ForCourse};
