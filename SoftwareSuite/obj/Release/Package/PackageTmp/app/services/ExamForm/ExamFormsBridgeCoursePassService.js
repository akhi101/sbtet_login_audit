define(['app'], function (app) {
    app.service("ExamFormsBridgeCoursePassService", function (DataAccessService) {
        this.AddExamFormsBridgeCoursePass = function (object) {
            var promise = DataAccessService.postData('api/ExamForms/PostInsertExamFormsForBridgeCoursePass', object); //PutExamForms
            return promise;
        }
        this.UpdateExamFormsBridgeCoursePass = function (object) {
            var promise = DataAccessService.postData('api/ExamForms/PostExamForms', object);
            return promise;
        }
        this.PostBridgeCourseGenerateIndiviual = function (object) {
            var promise = DataAccessService.postData('api/ExamForms/PostBridgeCourseGenerateIndiviual', object);
            return promise;
        }
        this.DeleteExamFormsBridgeCoursePass = function (ExmFrmID, UpdLoginID) {
        ...
        this.GetExamFormsBridgeCoursePassList = function (ExamInstID, CollegeID, CourseID, ExamID, BranchID) {
            var paramObject = { "ExamInstID": ExamInstID, "CollegeID": CollegeID, "CourseID": CourseID, "ExamID": ExamID, "BranchID": BranchID };
            var promise = DataAccessService.getDataWithPara('api/ExamForms/GetExamFormsListBridgeCoursePass', paramObject);
            return promise;
        }
        this.GetExamFormsBridgeCoursePassById = function (ExmFrmID) {
            var paramObject = { "ExmFrmID": ExmFrmID };
            var promise = DataAccessService.getDataWithPara('api/ExamForms/GetExamFormsByIdForBridge', paramObject);
            return promise;
        }
        ...
        this.GetExamFormDataByPrnNoForBridgeCourse = function (PRNNo, ExamInstID, CollegeID, CourseID, ExamID, BranchID) {
            var paramObject = { "PRNNo": PRNNo, "ExamInstID": ExamInstID, "CollegeID": CollegeID, "CourseID": CourseID, "ExamID": ExamID, "BranchID": BranchID };
            var promise = DataAccessService.getDataWithPara('api/ExamForms/GetExamFormDataByPrnNoForBridgeCourseNewOnlyPass', paramObject);
            return promise;
        }
        ...
        this.GetAcademicYearFeesByDate = function (object) {
            var promise = DataAccessService.getDataWithPara('api/ExamForms/GetAcademicYearFeesByDateForBridgeCourse', object);
            return promise;
        }
        ...
        this.GetCheckPRNNoPresent = function (PRNNo, ExamInstID, ForCourse) {
            var paramObject = {
                "PRNNo": PRNNo, "ExamInstID": ExamInstID, "ForCourse": ForCourse
            };
        ...
        this.GetBridgeExamFormFees = function (ExamInstID, ExamID) {
            var paramObject = { "ExamInstID": ExamInstID, "ExamID": ExamID };
            var promise = DataAccessService.getDataWithPara('api/ExamForms/GetBridgeExamFormFees', paramObject);
            return promise;
        }
        ...
        this.GetExmFormCntForBridgeCourse = function (PRNNo, ExamInstID, ExamID) {
            var paramObject = { "PRNNo": PRNNo, "ExamInstID": ExamInstID, "ExamID": ExamID };
            var promise = DataAccessService.getDataWithPara('api/ExamForms/GetExmFormCntForBridgeCourse', paramObject);
            return promise;
        }
    });
});