define(['app'], function (app) {
    app.service("ReAdmissionService", function (DataAccessService) {
        this.GetReqReAdmissionByID = function (ReAdmissionID) {
            var paramObject = { "ReAdmissionID": ReAdmissionID };
            var promise = DataAccessService.getDataWithPara('api/ReqReAdmission/GetReqReAdmissionByID', paramObject);
            return promise;
        }
        this.UpdateReAdmissionApp = function (object) {
            var promise = DataAccessService.postData('api/ReqReAdmission/PostApprovedReqReAdmission', object);
            return promise;
        }
        this.GetCertPdf = function (FormNo) {
            var paramObject = { "FormNo": FormNo };
            var promise = DataAccessService.getDataWithPara('api/ReqReAdmission/GetCertPdf', paramObject);
            return promise;
        }
