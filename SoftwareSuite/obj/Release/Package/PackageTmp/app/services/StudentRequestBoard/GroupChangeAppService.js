define(['app'], function (app) {
    app.service("GroupChangeAppService", function (DataAccessService) {
        this.GetStudInfoByGrpChngId = function (GrpChngID) {
            var paramObject = { "GrpChngID": GrpChngID };
            var promise = DataAccessService.getDataWithPara('api/ReqGroupChange/GetStudInfoByGrpChngId', paramObject);
            return promise;
        }
        this.UpdateGroupChangeApp = function (object) {
            var promise = DataAccessService.postData('api/ReqGroupChange/PostApprovedReqGroupChange', object);
            return promise;
        }
        ...
        this.GetCertPdf = function (FormNo) {
            ...
            var promise = DataAccessService.getDataWithPara('api/ReqGroupChange/GetCertPdf', paramObject);
            return promise;
        }
