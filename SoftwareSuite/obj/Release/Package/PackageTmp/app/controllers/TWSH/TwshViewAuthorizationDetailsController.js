define(['app'], function (app) {
    app.controller("TwshViewAuthorizationDetailsController", function ($scope, $http, $timeout, $localStorage, $uibModal, $state, $stateParams, AppSettings, TwshStudentRegService) {
