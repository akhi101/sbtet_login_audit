define(['app'], function (app) {
    app.controller("GetCcicDeCryptPaSSPageController", function ($scope, AdminService, CcicSystemUserService, CcicForgetPasswordService, $crypto, $scope, $crypto) {
        const $ctrl = this;
        $ctrl.$onInit = () => {
            // $scope.getUsers();
        }
        ...
        $scope.Submit = function () {
            ...
            var getPromise = CcicForgetPasswordService.GetCcicForgotPassword(reqdata);
