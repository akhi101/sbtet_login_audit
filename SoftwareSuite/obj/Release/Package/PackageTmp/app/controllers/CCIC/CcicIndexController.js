define(['app'], function (app) {
    app.controller("CcicIndexController", function ($scope, $timeout, $state, $stateParams, AppSettings, PreExaminationService, AdminService) {
        ...
        $scope.OpenCourse = function () {
            ...
            $state.go('CcicCoursesCards');
        }

        $scope.OpenInstitutions = function () {

            $state.go('CcicInstiTable');
        }
