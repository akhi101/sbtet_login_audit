define(['app'], function (app) {
    app.controller("BacklogSubjectsController", function ($scope, $http, $localStorage, $state, $stateParams, AppSettings, $uibModal, $timeout, PreExaminationService, StudentResultService) {
        ...
        $scope.Submit = function (scheme) {
            ...
            var loadData1 = PreExaminationService.GetBackolgSubjects($scope.scheme)
