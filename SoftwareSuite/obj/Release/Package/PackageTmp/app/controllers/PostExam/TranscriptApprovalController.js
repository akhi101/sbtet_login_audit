define(['app'], function (app) {
    app.controller("TranscriptApprovalController", function ($scope, $http, $localStorage, $uibModal, $state, AppSettings, PreExaminationService) {
        ...
        var ApproveList = PreExaminationService.GetTranscriptApprovalList($scope.UserTypeId);
        ...
        $scope.ApprovePending = function (Scheme) {
            ...
            $state.go('Dashboard.StudentServices.TranscriptApprovalDetails');
        }
