define(['app'], function (app) {
    app.controller("PromotionalListController", function ($scope, $http, $localStorage, $state, $stateParams, AppSettings, $uibModal, $timeout, PreExaminationService) {
        ...
        $scope.Submit = function (scheme) {
            ...
            var loadData1 = PreExaminationService.GetPromotionalList()
