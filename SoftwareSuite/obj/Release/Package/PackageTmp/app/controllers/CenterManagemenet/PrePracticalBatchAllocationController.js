define(['app'], function (app) {
    app.controller("PrePracticalBatchAllocationController", function ($scope, $state, $stateParams, AppSettings, PreZoneCenterService, BasicDistrictsService, BasicExamService, BasicCourseService) {
        ...
        $scope.PracticalBatchAllocatuionProcess = function () {
            ...
            if (CheckValidation() == true) {
                ...
                var getPromise = PreZoneCenterService.PostProcessCenterPractBatch($scope.PrePracticalBatchAllocation);
        ...
        function RedirectToListPage() {
            $scope.isupdatableDisable = false;
            $state.go('CenterManagemnet.PrePracticalBatchAllocation');
        }
    });
});
