define(['app'], function (app) {
    app.controller("PreZonePracticalController", function ($scope, $state, $stateParams, AppSettings, PreZoneService, BasicDistrictsService, BasicMandalService, BasicCollegeService) {
        $scope.PreZone = {};
        ...
        function FillData() {
           // var BasicDistrictList = BasicDistrictsService.GetBasicDistrictListByDistrictIds(AppSettings.DistrictIDs);
            ...
            BasicDistrictList.then(function (DistrictData, status, headers, config, error) {
                ...
                if ($scope.PreZone.ZoneID > 0) {
                    var PreZonedata = PreZoneService.GetPreZoneById($scope.PreZone.ZoneID, 2);
        ...
        function RedirectToListPage() {
            ...
            $scope.IsDelete = false;
            FillListData();
            $state.go('CenterManagemnet.PreZonePractical');
        }
        var gridColumns = [
            ...
            { field: "Bot_39", headerText: "Botony", textAlign: ej.TextAlign.Left, width: 25 },
        ...
        $scope.ShowCollegesFunction = function () {
            ...
            if ($scope.PreZone.ColCode != "") {
                var PreZoneCollegedata = PreZoneService.GetPreZoneCollegeCount(AppSettings.ExamInstID, $scope.PreZone.ColCode, 2);
                PreZoneCollegedata.then(function (data) {
                    if (data.length > 0) {
                        alert("It is allocated to Zone");
                        return;
                    }
                    var BasicCollegeData = BasicCollegeService.GetCollegeListByColCode($scope.PreZone.DistrictID, AppSettings.ExamInstID, $scope.PreZone.ColCode,2);
        ...
        function FillListData() {
            var PreZonedata = PreZoneService.GetPreZoneList(AppSettings.ExamInstID, 2, AppSettings.DistrictIDs);
            PreZonedata.then(function (data) {
        ...
        $scope.FillListDataNew = function (DistrictID) {
            var PreZonedata = PreZoneService.GetPreZoneList(AppSettings.ExamInstID, 2, DistrictID);
            PreZonedata.then(function (data) {
                $scope.PreZoneList = data;
            }, function (error) {
                alert(error);
