define(['app'], function (app) {
    app.controller("VocBridgePractAllocStudentListController", function ($scope, $state, $stateParams, AppSettings, BasicDistrictsService, BasicExamService, BasicCourseService, BasicCollegeService, PrePractCenterService, PreVocationalCenterService, BasicMainGroupService, BasicExamSubjectService, practicalEntryService) {
        ...
        function FillExamList(CourseID) {
            if (CourseID != "" || CourseID != undefined) {
                ...
                BasicExamList.then(function (ExamData, status, headers, config, error) {
                    ...
                    $scope.PracticalCenterAllocationStudentList.ExamID = "4";
        ...
        $scope.FillCenterListByZoneType = function (DistrictID) {
            if (DistrictID != "" || DistrictID != undefined) {
                var PraCenterList = PrePractCenterService.GetPracticalCenterListByDistrictIDANDZoneType(AppSettings.ExamInstID, 4, DistrictID);
        ...
        $("#reportviewer").ejReportViewer(
            {
                ...
                reportPath: "RptVocBridgeAllocStudentListReport.rdlc",
