define(['app'], function (app) {
    app.controller("PrePracticalBatchAllocationReportController", function ($scope, $state, $stateParams, AppSettings, PreZoneCenterService, BasicDistrictsService, BasicExamService, BasicCourseService, PrePractCenterService) {
        ...
        $("#reportviewer").ejReportViewer(
            {
                ...
                reportPath: "RptPracticalBatchReportbyCenter.rdlc",
