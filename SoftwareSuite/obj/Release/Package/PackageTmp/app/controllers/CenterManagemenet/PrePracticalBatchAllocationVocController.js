define(['app'], function (app) {
    app.controller("PrePracticalBatchAllocationVocController", function ($scope, $state, $stateParams, AppSettings, PreZoneCenterService, BasicDistrictsService, BasicExamService, BasicCourseService) {
        ...
        $scope.PracticalBatchAllocatuionProcessVocational = function () {
            $scope.isupdatableDisable = true;
            $scope.LoadImg = true;
            if (CheckValidation() == true) {
                ...
                var getPromise = PreZoneCenterService.PostProcessCenterPractBatchVoc($scope.PrePracticalBatchAllocation);
        ...
        function RedirectToListPage() {
            $scope.isupdatableDisable = false;
            $state.go('CenterManagemnet.PrePracticalBatchAllocationVoc');
        }
    });
});
