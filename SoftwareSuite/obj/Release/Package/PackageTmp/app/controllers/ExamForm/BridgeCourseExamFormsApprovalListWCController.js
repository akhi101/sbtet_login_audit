define(['app'], function (app) {
    app.controller("BridgeCourseExamFormsApprovalListWCController", function ($scope, $localStorage, $state, AppSettings, ExamFormsApprovalService) {
        ...
        $scope.FillCollData = function (CollegeID) {
            if (CollegeID != null) {
                ...
                CourseList.then(function (BasicCoursedata, status, headers, config, error) {
                    ...
                    $scope.FillCoursePart($scope.ExamFormsApprovalList.CourseID);
                }, function (error) {
                    alert(error);
                });
            }
        ...
        $scope.Show = function () {
            ...
            ExamFormData.then(function (data, status, headers, config, error) {
                if (data.length == 0) {
                    ...
                    var ChallanNoData = ExamFormsApprovalService.GetChallanNumberBridge(AppSettings.ExamInstID, $scope.ExamFormsApprovalList.ExamID, $scope.ExamFormsApprovalList.CollegeID);
        ...
        $scope.FormsApproval = function () {
           ...
           // var OrderID = makeid();
            ...
            var ExamFormsdata = ExamFormsApprovalService.PostApprovalFormsBridge(ExamForms);
