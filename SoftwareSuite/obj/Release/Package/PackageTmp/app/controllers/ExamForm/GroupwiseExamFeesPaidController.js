define(['app'], function (app) {
    app.controller("GroupwiseExamFeesPaidController", function ($scope, $http, $localStorage, $state, AppSettings, GroupwiseExamFeesPaidService) {
        ...
        var AcdYrList = GroupwiseExamFeesPaidService.GetCurrentAcademicYearForDrillDown();
        ...
        var DistrictList = GroupwiseExamFeesPaidService.GetDistrictListByStateID(1);
        ...
        var GroupList = GroupwiseExamFeesPaidService.GetMainGrpList($scope.VocGen);
        GroupList.then(function (MainGrpData, status, headers, config, error) {
            $scope.GroupList = MainGrpData;
        }, function (error) {
            alert(error);
            });


        var BasicManagementTypedata = GroupwiseExamFeesPaidService.GetBasicManagementTypeListWithAll();
        ...
        $scope.Submit = function () {
            ...
            document.getElementById('HeadLabel').innerHTML = 'Exam Fee Transaction Report <br/> Academic Year: ' + AcdYrSelectText + '&emsp;&emsp;District: ' + DistrictSelectText + '&emsp;&emsp; Stream: ' + optionStreamName + '&emsp;&emsp; Year:' + optionYearName + '&emsp;&emsp; Group:' + GroupSelectText;
            ...
            if (($scope.GroupList.MainGrpID == 0) || ($scope.GroupList.MainGrpID == undefined)) {
                alert("Select Group");
                return;
            }
            ...
            if (AppSettings.CollegeID == 0) {
                var TotalRecorddata = GroupwiseExamFeesPaidService.GetGroupwiseExamFeesPaidReport(AppSettings.AcdYrID, $scope.DrillDownExamFeesPaid.DistrictID, AppSettings.LoggedUserId, $scope.MngtTypIDs, $scope.Branch, $scope.ExamIDPara, $scope.GroupList.MainGrpID);
            }
            else {
                var gender = "";
                var TotalRecorddata = GroupwiseExamFeesPaidService.GetDrillExamFeesPaidReport(AppSettings.AcdYrID, $scope.DrillDownExamFeesPaid.DistrictID, AppSettings.LoggedUserId, $scope.MngtTypIDs, $scope.Branch, $scope.ExamIDPara, $scope.GroupList.MainGrpID);
            }
        ...
        $scope.GetCandidates = function (obj) {
            ...
            var TotalRecorddata = GroupwiseExamFeesPaidService.GetCandidateDetailsByCollegeGroup(AppSettings.AcdYrID, obj.CollegeID, $scope.ExamID, $scope.GroupList.MainGrpID);
            TotalRecorddata.then(function (data) {
