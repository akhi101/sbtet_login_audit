define(['app'], function (app) {
    app.controller("BridgeCourseExamFeeStatusController", function ($scope, $filter, $state, $interval, $stateParams, AppSettings, RegisterAdmittedStudentService, BasicExamService) {
        $scope.Print = function () {
            ...
            var Urlstring = "api/ExamForms/GetExamFeeStatusBridge/?CollegeID=" + AppSettings.CollegeID + "&CourseID=" + $scope.CourseID + "&BranchID=" + $scope.BranchID + "&ReportType=" + $scope.ReportType + "&ExamInstID=" + AppSettings.ExamInstID + "&ExamID=" + $scope.ExamID;
            $.ajax({
                ...
                success: function (result) {
                    ...
                    var datasetName1 = "dsBridgeCourseExamFeeStatus";
                    if (data[0].length == 0) {
        ...
        $("#container").ejReportViewer(
            {
                ...
                reportPath: "RptBridgeCourseExamFeeStatusReport.rdlc",
                dataSources: [{ value: [], name: "dsBridgeCourseExamFeeStatus" }],
