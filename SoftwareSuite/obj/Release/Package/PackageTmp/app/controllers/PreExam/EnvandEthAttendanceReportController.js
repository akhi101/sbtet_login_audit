define(['app'], function (app) {
    ...
    app.controller("EnvandEthAttendanceReportController", function ($scope, $http, $localStorage, $state, AppSettings, MenuService, basicExamService, otherMarkEnrtyService, DrillDownService) {
        $scope.Admission = {};
        ...
        var CourseList = DrillDownService.GetBasicCourseList();
            CourseList.then(function (Coursedata, status, headers, config, error) {
                ...
                $scope.Admission.CourseID = "" + $scope.CourseList[0].CourseID + ""; 
        ...
        $scope.FillCoursePart = function (CourseID) {
            if ((CourseID != null) && (CourseID != undefined) && (CourseID != "")) {
                ...
                MainGroupList.then(function (MainGroupListdata, status, headers, config, error) {
                    ...
                    basicExamService.getBasicExamListByCourseID(CourseID).then(function (results) {
                        ...
                        otherMarkEnrtyService.getExamTimeTableSubjectListByExamIDBranchID($scope.Admission.ExamID, 0, $scope.Admission.ExamInstID).then(function (results) {
        ...
        $scope.Submit = function () {     
            ...
            if ($scope.adminuser == true || $scope.jsuser == true || $scope.coeuser == true) {
                var TotalRecorddata = DrillDownService.GetDrillDownStudentDetailsListENVandETH($scope.Admission.ExamInstID, $scope.otherMarkEnrtyDetail.ExmSubID);
        ...
        $scope.GetTotalRecord_js = function (obj, type) {
            ...
            if ($scope.DistCode != "" && $scope.type != "") {
                ...
                var TotalRecorddata = DrillDownService.GetDrillDownStudentDetailsListENVandETHByCollegeByDistristCodeWithType($scope.Admission.ExamInstID, $scope.otherMarkEnrtyDetail.ExmSubID, $scope.DistCode, $scope.type , obj.CollegeID);
                //var TotalRecorddata = DrillDownService.GetDrillDownStudentDetailsListENVandETHByCollegeByDistristCode($scope.Admission.ExamInstID, $scope.otherMarkEnrtyDetail.ExmSubID, $scope.DistCode);
            }
            else {
        ...
        $scope.GetTotalRecord_coe = function (obj, type) {
            ...
            if ($scope.DistCode != "" && $scope.type != "") {                
                    ...
                    var TotalRecorddata = DrillDownService.GetDrillDownStudentDetailsListENVandETHByCollegeByDistristCodeWithType($scope.Admission.ExamInstID, $scope.otherMarkEnrtyDetail.ExmSubID, AppSettings.DistrictIDs, $scope.type, obj.CollegeID);
                }           
            TotalRecorddata.then(function (data) {
                $scope.colPageAdmissionList = data;
                $scope.SetDefault();
