define(['app'], function (app) {
    app.controller("PhotoCorrectionApprovalController", function ($scope, $state, $localStorage, $stateParams, AppSettings, NRCorrectionApprovalListService) {
        $scope.PhotoCorrectionApproval = { CollegeID: $stateParams.CollegeID, ExamID: $stateParams.ExamID };
