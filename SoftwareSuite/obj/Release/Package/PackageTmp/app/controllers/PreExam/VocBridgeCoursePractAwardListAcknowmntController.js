define(['app'], function (app) {
    app.controller("VocBridgeCoursePractAwardListAcknowmntController", function ($scope, $state, $stateParams, AppSettings, BasicDistrictsService) {
        ...
        $scope.PrintPracticalAcknowledgement = function () {
            ...
            var Urlstring = "api/PracticalEntry/GetVocBridgePracticalMarkEntryAwardListReport/?PrePractCntrID=" + PrePractCntrID + "&ExamInstID=" + ExamInstID + "&ExmSubID=" + ExmSubID + "&ExamID=" + ExamID + "&BatchNo=" + BatchNo + "&PrDate=" + PrDate + "";
            $.ajax({
        ...
        $("#reportviewer").ejReportViewer(
            {
                ...
                reportPath: "RptVocBridgePracticalAwardListAcknowledgement.rdlc",
