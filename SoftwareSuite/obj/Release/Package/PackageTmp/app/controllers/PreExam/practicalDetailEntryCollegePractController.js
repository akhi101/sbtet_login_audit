(function () {
    'use strict';
    angular.module('app')
        .controller('practicalDetailEntryCollegePractController',
            function ($rootScope, $scope, $state, basicCourseService, basicExamService, examTimeTableService, practicalEntryService, basicZoneService, basicBranchService, basicDistrictsService, AppSettings) {
                ...
                var getAllBasicCourse = function () {
                    basicCourseService.getAllBasicCourse($scope.practicalEntryDetailCollege.CourseID).then(function (results) {
                        ...
                        $scope.practicalEntryDetailCollege.CourseID = $scope.basicCourses[1].CourseID;
                    });
                };
                ...
                $scope.$watch('practicalEntryDetailCollege.MainGrpID', function () {
                    ...
                    if ($scope.practicalEntryDetailCollege.MainGrpID !== undefined) {
                        if ($scope.practicalEntryDetailCollege.BranchID !== undefined) {
                            $scope.practicalEntryDetailCollege.ExamInstID = AppSettings.ExamInstID; // Current ExamInstID
                            practicalEntryService.getExamTimeTableSubjectListByExamIDBranchIDForVocPract($scope.practicalEntryDetailCollege.ExamID, $scope.practicalEntryDetailCollege.BranchID, $scope.practicalEntryDetailCollege.ExamInstID, $scope.practicalEntryDetailCollege.MainGrpID).then(function (results) {
                    ...
                    if ($scope.practicalEntryDetailCollege.CourseID !== undefined) {
                        ...
                        practicalEntryService.getCheckCenterCollegePresent(AppSettings.CollegeID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.CourseID).then(function (results) {
                            if (results == 0) {
                                ...
                                practicalEntryService.GetBasicMainGroupForVocPractWithDate($scope.practicalEntryDetailCollege.PrePractCntrID, $scope.SerDate).then(function (results) {
                                    $scope.basicMainGrps = results;
                                });
                            }
                        });
                    }
                ...
                $scope.$watch('practicalEntryDetailCollege.ExamID', function () {
                    ...
                    if ($scope.practicalEntryDetailCollege.ExamID !== undefined) {
                        ...
                        practicalEntryService.GetBasicMainGroupForVocPractWithDate($scope.practicalEntryDetailCollege.PrePractCntrID, $scope.practicalEntryDetailCollege.Prdate).then(function (results) {
                            $scope.basicMainGrps = results;
                        });
                    }
                ...
                $scope.$watch('practicalEntryDetailCollege.ExmSubID', function () {
                    ...
                    if ($scope.practicalEntryDetailCollege.ExmSubID !== undefined && $scope.practicalEntryDetailCollege.ExamID !== undefined) {
                        ...
                        $scope.practicalEntryDetailCollege.BatchFlag = "";
                        practicalEntryService.getFillBatchDataForVocWithDate(AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.ExamID, $scope.practicalEntryDetailCollege.PrePractCntrID, $scope.practicalEntryDetailCollege.ExmSubID, $scope.practicalEntryDetailCollege.BatchFlag, $scope.practicalEntryDetailCollege.ZoneType, $scope.practicalEntryDetailCollege.Prdate,$scope.practicalEntryDetailCollege.MainGrpID).then(function (results) {
                        ...
                        practicalEntryService.getExaminerDatabyCenterForVocWithDate(AppSettings.CollegeID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.ExamID, $scope.practicalEntryDetailCollege.ExmSubID, $scope.practicalEntryDetailCollege.ZoneType, $scope.practicalEntryDetailCollege.Prdate).then(function (results) {
                            if (results.length > 0) {
                ...
                $scope.ShowOnlyData = function () {
                    ...
                    if ($scope.practicalEntryDetailCollege.ExaminerID == undefined || $scope.practicalEntryDetailCollege.ExaminerID == "" || $scope.practicalEntryDetailCollege.ExaminerID == "0") {
                        alert("Please Map Examiner");
                        return;
                    }
                ...
                $scope.showStudentDetails = function () {
                    if ($scope.practicalEntryDetailCollege.ExmSubID !== undefined && $scope.practicalEntryDetailCollege.BranchID !== undefined && $scope.practicalEntryDetailCollege.ExamID !== undefined && $scope.practicalEntryDetailCollege.PrePractCntrID && $scope.practicalEntryDetailCollege.CourseID) {
                        ...
                        $scope.practicalEntryDetailCollege.CreateLoginID = AppSettings.LoggedUserId;
                        $scope.loading = true;
                        practicalEntryService.GetStudentDetailsByExamSubjectForVoc($scope.practicalEntryDetailCollege).then(function (results) {
                            if (results.length > 0) {
                                var final = 0;
                                $scope.practicalEntryDetailCollege.TotalMarks = 0;
                ...
                $scope.postpracticalEntryDetailCollege = function () {
                    ...
                    $scope.updatedStudentInfoList = [];
                    //&& $scope.practicalEntryDetailCollegeForm.$valid
                    if ($scope.practicalStudentDetailForm.$valid  && $scope.studentDetailList.length > 0) {
                        for (var i = 0; i < $scope.studentDetailList.length; i++) {
                            ...
                            $scope.studentDetailList[i].PractType = 2;
                        ...
                        if ($scope.isCorrect) {
                            if ($scope.updatedStudentInfoList.length > 0) {
                                ...
                                $scope.practicalEntryDetailCollege.CreateLoginID = AppSettings.LoggedUserId;
                                $scope.practicalEntryDetailCollege.PractType = 2;
                                $scope.practicalEntryDetailCollege.CenterCollegeID = AppSettings.CollegeID;
                ...
                $scope.postpracticalEntryDetailCollegeFinalSubmit = function () {
                    ...
                    practicalEntryService.postPracticalEntryFinalSubmit($scope.postPracticalEntry).then(function (results) {
                        if (results.IsSuccess) {
                           ...
                           // $state.go('PreExam');
                            //$scope.practicalEntryDetailCollege.PrDate = $("#Prdate").val();
                            $state.go('PreExam.VocationalPracticalAwardListAcknowledgement', { PrePractCntrID: $scope.practicalEntryDetailCollege.PrePractCntrID, ExmSubID: $scope.practicalEntryDetailCollege.ExmSubID, BatchNo: $scope.practicalEntryDetailCollege.BatchNo, ExamID: $scope.practicalEntryDetailCollege.ExamID, PrDate: $scope.practicalEntryDetailCollege.Prdate, MainGrpID: $scope.practicalEntryDetailCollege.MainGrpID });
                            $scope.DisableFinalSubmit = true;
                            $scope.savedisable = true;
                            $scope.loading = false;
                        } else {
                    ...
                    if (HTNO != "") {
                        ...
                        practicalEntryService.GetHTNoPresentInPreStudentMarks(HTNO, $scope.practicalEntryDetailCollege.ExamID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.PrePractCntrID, $scope.practicalEntryDetailCollege.ExmSubID).then(function (results) {
                            if (results.length > 0) {
                                ...
                                practicalEntryService.GetHTNoPresentInExamFormsForVoc(HTNO, $scope.practicalEntryDetailCollege.ExamID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.PrePractCntrID, $scope.practicalEntryDetailCollege.ExmSubID, $scope.practicalEntryDetailCollege.BatchNo, 3, $scope.practicalEntryDetailCollege.MainGrpID).then(function (resultspre) {
                                    if (resultspre.length > 0) {
                                        ...
                                        if (resultspre[0].BatchNo != $scope.practicalEntryDetailCollege.BatchNo) {
                                            ...
                                            if (isConfirmed) {
                                                ...
                                                $scope.studentDetailList[$scope.studentDetailList.length - 1].ExmSubID = resultspre[0].ExmSubID;
                                            } else {
                                        ...
                                        //var isConfirmed = confirm("HTNo is not present for that group , Do you want to add this ? ?");
                                        //if (isConfirmed) {
                                        //    $scope.studentDetailList[$scope.studentDetailList.length - 1].StudName = resultspre[0].StudName;
                                        //} else {
                                        //    $scope.studentDetailList[$scope.studentDetailList.length - 1].HTNO = "";
                                        //    return;
                                        //}
                                        alert("HTNo is not present for that group");
                                        $scope.studentDetailList[$scope.studentDetailList.length - 1].HTNO = "";
                                        return;
                                    }
                                }, function (error) {
                ...
                $scope.printDiv = function (divName) {
                    ...
                    $state.go('PreExam.practicalDetailEntryCollegePract');
                }
