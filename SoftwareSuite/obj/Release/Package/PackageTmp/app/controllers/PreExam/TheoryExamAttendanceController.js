(function () {
    'use strict';
    angular.module('app')
        .controller('TheoryExamAttendanceController',
        function ($rootScope, $state, $scope, basicCourseService, basicExamService, examTimeTableService, TheoryExamAttendanceService, basicZoneService, basicBranchService, basicDistrictsService, basicCollegeService, AppSettings) {
            ...
            //$scope.studentDetail.StatusFlag = "P";
            $scope.init = function () {
                $scope.CheckBrowser();
                getCollegeInfo();
                getExaminerDetails();
            ...
            var getScheduleDetails = function () {
                TheoryExamAttendanceService.getScheduleDetails($scope.CollegeID, $scope.otherMarkEnrtyDetail.ExmSubID).then(function (results) {
                    if (results.length > 0) {
            ...
            var getCollegeInfo = function () {
                TheoryExamAttendanceService.getCollegeInfo(AppSettings.CollegeID).then(function (results) {
            ...
            var getDistrictByCollegeID = function () {
                TheoryExamAttendanceService.getDistrictDetails($scope.CollegeID).then(function (results) {
                    $scope.otherMarkEnrtyDetail.DistrictID = results[0].DistrictID;
                });
            };
            var getExaminerDetails = function () {
                TheoryExamAttendanceService.getExaminerDetails($scope.CollegeID).then(function (results) {
                    if (results.length > 0) {
                        if (results[0].ErrMsg != "" && results[0].ErrMsg != null) {
                            alert(results[0].ErrMsg);
                        }
            ...
            var getHTNoDetails = function (HTNO, index) {
                //TheoryExamAttendanceService.getHTNoDetails(HTNO).then(function (results) {
                TheoryExamAttendanceService.getPostHTNoDetails(HTNO, $scope.otherMarkEnrtyDetail.ExmSubID).then(function (results) {
                    if (results.length > 0) {
                        if (results[0].HTNO != 0) {
            ...
            //                TheoryExamAttendanceService.postExaminerInfo($scope.postotherMarkEnrty).then(function (results) {
            ...
            $scope.$watch('otherMarkEnrtyDetail.CourseID', function () {
                ...
                if ($scope.otherMarkEnrtyDetail.CourseID !== undefined) {
                    basicExamService.getBasicExamListByCourseID($scope.otherMarkEnrtyDetail.CourseID).then(function (results) {
                        ...
                        TheoryExamAttendanceService.getExamTimeTableSubjectListByExamIDBranchID($scope.otherMarkEnrtyDetail.ExamID, 0, $scope.otherMarkEnrtyDetail.ExamInstID).then(function (results) {
            ...
            $scope.$watch('otherMarkEnrtyDetail.ExmSubID', function () {
                ...
                if ($scope.otherMarkEnrtyDetail.ExmSubID !== undefined) {
                    ...
                    TheoryExamAttendanceService.getMFNumber($scope.CollegeID, $scope.otherMarkEnrtyDetail.ExmSubID, $scope.otherMarkEnrtyDetail.CourseID, $scope.ExmSubCode).then(function (results) {
            ...
            $scope.showStudentDetail = function () {
                ...
                if ($scope.otherMarkEnrtyStudentDetailForm.$valid && $scope.otherMarkEnrtyDetail.ExmSubID !== undefined && $scope.otherMarkEnrtyDetail.ExamID !== undefined && $scope.otherMarkEnrtyDetail.CollegeID != undefined && $scope.otherMarkEnrtyDetail.CourseID != undefined) {
                    ...
                    TheoryExamAttendanceService.getStudentDetailsByExamSubject($scope.otherMarkEnrtyDetail).then(function (results) {
                        if (results.length > 0) {
                            if (results[0].ErrMsg != "" && results[0].ErrMsg != null) {
                                alert(results[0].ErrMsg);
                                $scope.LoadImg = false;
            ...
            $scope.submitOtherMarkEnrtyDetail = function () {
                ...
                if (_confirm == true) {
                    ...
                    TheoryExamAttendanceService.postOtherMarkVerification($scope.postotherMarkEnrty).then(function (results) {
                        if (results.IsSuccess) {
                            $scope.otherMarkEnrtyDetail = {};
                            $scope.studentDetailList = [];
                            $scope.updatedStudentInfoList = [];
                ...
                if ($scope.otherMarkEnrtyStudentDetailForm.$valid && $scope.otherMarkEnrtyDetailForm.$valid && $scope.studentDetailList.length > 0) {
                    ...
                    if ($scope.isCorrect) {
                        if ($scope.updatedStudentInfoList.length > 0 || $scope.saveStudentInfoList.length > 0) {
                            ...
                            TheoryExamAttendanceService.postOtherMarkEnrty($scope.postotherMarkEnrty).then(function (results) {
                                if (results.IsSuccess) {
                                    $scope.LoadImg = false;
                                    $scope.SaveLoadImg = false;
                                    $scope.SaveDisable = false;
            ...
            //                    if (results.IsSuccess) {
            //                    if ($scope.studentDetailList[index].RecordID == 0) {
            //                        TheoryExamAttendanceService.getPostHTNoDetails($scope.studentDetailList[index].HTNO, $scope.otherMarkEnrtyDetail.ExmSubID).then(function (results) {
            //                                if (results.length > 0) {
            ...
            $scope.DeleteRow = function (index) {
                if ($scope.studentDetailList[index].RecordID == "0" || $scope.studentDetailList[index].RecordID == undefined || $scope.studentDetailList[index].RecordID == "") {
                    ...
                    //                if (results[0].RecordID != 0) {
                    //                    $scope.studentDetailList[index].RecordID = results[0].RecordID;
                    //                    TheoryExamAttendanceService.deleteHTNO($scope.studentDetailList[index].RecordID).then(function (results) {
                    //                        if (results == "0") {
