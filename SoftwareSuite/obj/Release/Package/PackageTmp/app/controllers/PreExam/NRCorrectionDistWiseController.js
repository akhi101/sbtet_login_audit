define(['app'], function (app) {
    app.controller("NRCorrectionDistWiseController", function ($scope, $http, $localStorage, $state, AppSettings, NRCorrectionDistWiseService) {
        ...
        var AcdYrList = NRCorrectionDistWiseService.GetCurrentAcademicYearForDrillDown();
        ...
        var DistrictList = NRCorrectionDistWiseService.GetDistrictListByStateID(1);
        ...
        var BasicManagementTypedata = NRCorrectionDistWiseService.GetBasicManagementTypeListWithAll();
        ...
        $scope.Submit = function () {
            ...
            if (AppSettings.CollegeID == 0) {
                var TotalRecorddata = NRCorrectionDistWiseService.GetNRCorrectionListDistrictwise($scope.MngtTypIDs, $scope.DrillDownExamFeesPaid.DistrictID, AppSettings.LoggedUserId);
            }
            else {
                var gender = "";
                var TotalRecorddata = NRCorrectionDistWiseService.GetCollegeExamFeeTransactionSummary(AppSettings.AcdYrID, AppSettings.CollegeID);
            }
        ...
        $scope.GetDistrictLevelDetails = function (obj) {
            ...
            var TotalRecorddata = NRCorrectionDistWiseService.GetDistrictLevelDetails(AppSettings.AcdYrID, obj.DistrictID, AppSettings.LoggedUserId, $scope.MngtTypIDs, $scope.ExamID);
            TotalRecorddata.then(function (data) {
        ...
        $scope.GetCandidates = function (obj) {
            $scope.CandidatesList = [];
            var TotalRecorddata = NRCorrectionDistWiseService.GetCandidateDetailsTransSummByCollege(AppSettings.AcdYrID, obj.CollegeID, $scope.ExamID);
            TotalRecorddata.then(function (data) {
