(function () {
    'use strict';
    angular.module('app')
        .controller('practicalDetailEntryCollegePreviousController',
            function ($rootScope, $scope, $state, basicCourseService, basicExamService, examTimeTableService, practicalEntryService, basicZoneService, basicBranchService, basicDistrictsService, AppSettings) {
                ...
                var getAllBasicCourse = function () {
                    basicCourseService.getAllBasicCourse($scope.practicalEntryDetailCollege.CourseID).then(function (results) {
                        ...
                        $scope.PreSerDate = $scope.basicCourses[0].PreSerDate;
                        $("#Prdate").ejDatePicker({ maxDate: $scope.PreSerDate, allowEdit: true, dateFormat: "dd/MMM/yyyy" });
                ...
                $scope.$watch('practicalEntryDetailCollege.ExmSubID', function () {
                    if ($scope.practicalEntryDetailCollege.ExmSubID !== undefined && $scope.practicalEntryDetailCollege.ExamID !== undefined) {
                        ...
                        $scope.practicalEntryDetailCollege.Prdate = $("#Prdate").val();
                        $scope.practicalEntryDetailCollege.BatchFlag = "";
                        practicalEntryService.getFillBatchDataForPrevious(AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.ExamID, $scope.practicalEntryDetailCollege.PrePractCntrID, $scope.practicalEntryDetailCollege.ExmSubID, $scope.practicalEntryDetailCollege.BatchFlag, $scope.practicalEntryDetailCollege.ZoneType, $scope.practicalEntryDetailCollege.Prdate,0 ).then(function (results) {
                        ...
                        practicalEntryService.getExaminerDatabyCenterForPrevious(AppSettings.CollegeID, AppSettings.ExamInstID, $scope.practicalEntryDetailCollege.ExamID, $scope.practicalEntryDetailCollege.ExmSubID, $scope.practicalEntryDetailCollege.ZoneType, $scope.practicalEntryDetailCollege.Prdate).then(function (results) {
                            if (results.length > 0) {
                ...
                $scope.postpracticalEntryDetailCollegeFinalSubmit = function () {
                    ...
                    practicalEntryService.postPracticalEntryFinalSubmit($scope.postPracticalEntry).then(function (results) {
                        if (results.IsSuccess) {
                            ...
                            $state.go('PreExam.PracticalMarkEntryAcknowledgementReport', { PrePractCntrID: $scope.practicalEntryDetailCollege.PrePractCntrID, ExmSubID: $scope.practicalEntryDetailCollege.ExmSubID, BatchNo: $scope.practicalEntryDetailCollege.BatchNo, ExamID: $scope.practicalEntryDetailCollege.ExamID, PrDate: $scope.practicalEntryDetailCollege.Prdate });
                            $scope.DisableFinalSubmit = true;
                            $scope.savedisable = true;
                            $scope.loading = false;
                ...
                $scope.printDiv = function (divName) {
                    ...
                    $state.go('PreExam.practicalDetailEntryCollegePrevious');
                }
