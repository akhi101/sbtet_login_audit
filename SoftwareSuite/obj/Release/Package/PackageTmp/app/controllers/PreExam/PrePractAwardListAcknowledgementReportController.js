define(['app'], function (app) {
    app.controller("PrePractAwardListAcknowledgementReportController", function ($scope, $state, $stateParams, AppSettings,BasicDistrictsService ) {
        ...
        $scope.PrintPracticalAcknowledgement = function () {
            ...
            var Urlstring = "api/PracticalEntry/GetPracticalAwardListAcknowledgeMentReport/?PrePractCntrID=" + PrePractCntrID + "&ExamInstID=" + ExamInstID + "&ExmSubID=" + ExmSubID + "&ExamID=" + ExamID + "&BatchNo=" + BatchNo + "&PrDate=" + PrDate + "";
                $.ajax({
        ...
        $("#reportviewer").ejReportViewer(
            {
                ...
                reportPath: "RptPracticalAwardListAcknowledgementReport.rdlc",
