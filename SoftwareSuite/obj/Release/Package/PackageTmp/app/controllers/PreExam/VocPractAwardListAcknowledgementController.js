define(['app'], function (app) {
    app.controller("VocPractAwardListAcknowledgementController", function ($scope, $state, $stateParams, AppSettings, BasicDistrictsService) {
        $scope.PracticalMarkEntryAcknowledgementReport = { PrePractCntrID: $stateParams.PrePractCntrID, ExmSubID: $stateParams.ExmSubID, BatchNo: $stateParams.BatchNo, ExamID: $stateParams.ExamID, PrDate: $stateParams.PrDate, MainGrpID: $stateParams.MainGrpID };
        ...
        $scope.PrintPracticalAcknowledgement = function () {
            ...
            var MainGrpID = $scope.PracticalMarkEntryAcknowledgementReport.MainGrpID;

            //if (CheckValidation() == true) {GetPracticalAwardListAcknowledgeMentReport   GetVocPracticalAwardListAcknowledgeMentReport
            var Urlstring = "api/PracticalEntry/GetVocPracticalAwardListAcknowledgeMentReport/?PrePractCntrID=" + PrePractCntrID + "&ExamInstID=" + ExamInstID + "&ExmSubID=" + ExmSubID + "&ExamID=" + ExamID + "&BatchNo=" + BatchNo + "&PrDate=" + PrDate + "&MainGrpID=" + MainGrpID + "";
            $.ajax({
