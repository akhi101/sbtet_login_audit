define(['app'], function (app) {
    app.controller("StudStatusReportController", function ($scope, $state, AppSettings, StudentRegService, RegisterAdmittedStudentService) {
        $scope.StudStatusReport = {};
        ...
        //    }
        //}
        $scope.StudStatusReport.ReportType = 'Y';
        var gridColumns = [
        ...
        $scope.StudStatusReportData = [];
        $("#StudentRegsRpt").ejGrid({
            dataSource: $scope.StudStatusReportData,
            allowPaging: true,
        ...
        $scope.Show = function () {
            ...
            if (($scope.StudStatusReport.ReportType == undefined) || ($scope.StudStatusReport.ReportType == "")) {
                alert("Select Report Type");
                return;
            }
            var StudentRegdata = StudentRegService.FillStudRegStatusForReport(AppSettings.CollegeID, $scope.CourseID, $scope.BranchID, $scope.StudStatusReport.ReportType);
            //if ($scope.StudStatusReport.ReportType == 'NC') {
            //    var StudentRegdata = StudentRegService.FillStudRegListForRecogFeeRptForNotConfirm(AppSettings.CollegeID, $scope.CourseID, $scope.BranchID, $scope.StudStatusReport.ReportType);
            //} else {
            //    var StudentRegdata = StudentRegService.FillStudRegListForRecogFeeRpt(AppSettings.CollegeID, $scope.CourseID, $scope.BranchID, $scope.StudStatusReport.ReportType);
            //}
