define(['app'], function (app) {
    app.controller("StudentBioDataListController", function ($scope, $state, $localStorage, AppSettings, StudentRegService, RegisterAdmittedStudentService, $uibModal) {
        //  alert("hi");
    ...
    app.controller("StudentRegController", function ($filter, $http, $scope, $state, $localStorage, $stateParams, AppSettings, StudentRegService) {
