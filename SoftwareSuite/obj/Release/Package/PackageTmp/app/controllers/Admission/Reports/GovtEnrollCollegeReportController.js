define(['app'], function (app) {
    app.controller("GovtEnrollCollegeReportController", function ($scope, $localStorage, $filter, $state, $interval, $stateParams, AppSettings, MenuService) {
        ...
        $scope.GovtOrPvt = "G";
        $scope.rptName = "RptCollegeStudentEnrollmentCount.rdlc";
        ...
        $scope.Print = function () {
            ...
            if ($scope.GovtOrPvt == "G") {
                ...
                $scope.rptName = "RptCollegeStudentEnrollmentCountPVT.rdlc";
            }
            ...
            var Urlstring = "api/GovtColEnroll/GetGovtEnrollCollegeReportGovtOrPvt/?AcdYrID=" + AppSettings.AcdYrID + "&DistrictID=" + $scope.DistrictID + "&LoggedUserId=" + AppSettings.LoggedUserId + "&GovtOrPvt=" + $scope.GovtOrPvt;
            $.ajax({
                ...
                success: function (result) {
                    ...
                    var datasetName1 = "dsCollegeStudentEnrollment";
                    if (data[0].length == 0) {
        ...
        $scope.ClgTypeChange = function (GovtOrPvt) {
                ...
                $("#reportviewer").ejReportViewer(
                    {
                        ...
                        dataSources: [{ value: [], name: "dsCollegeStudentEnrollment" }],
            ...
            var reportModel = $("#reportviewer").data('ejReportViewer');
            reportModel.model.dataSources = [{ value: [], name: "dsCollegeStudentEnrollment" }];
            reportModel._refreshReport();
        }
        $("#reportviewer").ejReportViewer(
            {
